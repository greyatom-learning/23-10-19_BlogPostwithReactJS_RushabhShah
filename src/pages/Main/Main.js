...
class Main extends Component {
    state = {
        ...
        blogs: [
            ...
            },
            {
                ...
                author: "Dr. John Watson",
                cover_photo: "http://learnenglishbylistening.com/wp-content/uploads/2019/08/The-Final-Problem-thumb.jpg",
    ...
    addBlogHandler = (value) => {
        let blogs = this.state.blogs;
        let newBlog = {
            title: value.title.value,
            author: value.author.value,
            synopsis: value.content.value,
            cover_photo: value.cover_photo ? value.cover_photo.value : null
        }
        blogs.push(newBlog);
        this.setState({
            blogs: blogs
